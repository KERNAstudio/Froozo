    ...
    <>
      ...
      <main id="main">
        {/* Hero — the entrance. Pulled up behind the sticky header (-mt) so the
            ...
            place for a beat of scroll before releasing, so the page never
            feels like it's catching against a section boundary mid-scroll. */}
        <div id="hero" className="relative -mt-24 h-[170vh] md:-mt-28">
          <section className="sticky top-0 flex min-h-dvh items-center justify-center overflow-hidden px-5 py-32 text-center">
            <div
        ...
        <div id="lane" className="relative h-[170vh]">
          <section className="sticky top-0 flex min-h-dvh flex-col justify-center bg-teal py-24 text-cream">
